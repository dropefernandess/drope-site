    ...
    >
      {step === 1 && (
        <>
          ...
          <g className="ds1-sweep" style={{ transformOrigin: "60px 60px" }}>
            <line x1="60" y1="60" x2="60" y2="12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="0.7" />
            <circle cx="60" cy="12" r="3" fill="currentColor" />
          </g>
          <circle cx="82" cy="44" r="4" fill="currentColor" className="ds1-blip" />
          <circle cx="40" cy="76" r="3" fill="currentColor" className="ds1-blip-2" />
        </>
      )}
      ...
      {step === 2 && (
        <>
          ...
          <g stroke="currentColor" strokeWidth="1" strokeDasharray="3 4" opacity="0.3">
          ...
          <circle cx="42" cy="18" r="3" fill="currentColor" className="ds1-blip" />
          <circle cx="78" cy="104" r="3" fill="currentColor" className="ds1-blip-2" />
      ...
      {step === 3 && (
        <>
          ...
          <g stroke="currentColor" strokeWidth="1.5">
            <rect x="18" y="16" width="84" height="26" rx="6" className="ds3-b1" fill="currentColor" fillOpacity="0.06" />
            <rect x="18" y="50" width="44" height="52" rx="6" className="ds3-b2" fill="currentColor" fillOpacity="0.06" />
            <rect x="70" y="50" width="32" height="52" rx="6" className="ds3-b3" fill="currentColor" fillOpacity="0.06" />
          </g>
          {/* linhas de conteúdo do header */}
          <g stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="ds3-b1">
            <line x1="26" y1="26" x2="58" y2="26" opacity="0.5" />
            <line x1="26" y1="33" x2="44" y2="33" opacity="0.3" />
          </g>
          {/* cursor flutuando (eco dos cursores da CTA) */}
      ...
      {step === 4 && (
        <g className="ds4-wrap">
          ...
          />
          {/* sparkles */}
          <path d="M100 24 v10 M95 29 h10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" className="ds1-blip" />
          <path d="M18 88 v8 M14 92 h8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" className="ds1-blip-2" />
        </g>
      )}
    </svg>
  );
